...
const EXCHANGE_SYMBOLS: { [key: string]: string[] } = {
  ...
  okx: [
    "BTC-USDT", "BTC-USD", "SHIB-USDT", "SHIB-USD", "LUNC-USDT", "LUNC-USD", "LUNA-USDT", "LUNA-USD",
    "XLM-USDT", "XLM-USD", "XRP-USDT", "XRP-USD", "VOLTINU-USDT", "KISHU-USDT",
    "PEPE-USDT", "PEPE-USD", "WEN-USDT", "VINU-USDT", "BONK-USDT", "TURBO-USDT", "TURBO-USD",
    "USD1-USDT", "USD1-USD"
  ],
  gateio: [

...
const EXCHANGE_SYMBOLS: { [key: string]: string[] } = {
  ...
  kraken: [
    ...
    "XRPUSD", "XRPUSDT", "XRPUSDC", "XRPEUR", "XRPGBP", "XRPUSD1", "PEPEUSD", "PEPEUSDT", "PEPEUSDC", "PEPEEUR", "PEPEGBP", "PEPEUSD1", "PEPEAUD", "PEPECAD",
  ...
  okx: [
    "BTC-USDT", "BTC-USD", "BTC-BRL", "ETH-BRL", "SHIB-USDT", "SHIB-USD", "SHIB-BRL", "LUNC-USDT", "LUNC-USD", "LUNA-USDT", "LUNA-USD",
    "XLM-USDT", "XLM-USD", "XLM-BRL", "XRP-USDT", "XRP-USD", "XRP-BRL", "VOLTINU-USDT", "KISHU-USDT",
